...
def scrap_linkedin_with_sentiment(keywords):
    ...
    for keyword in keywords:
        ...
        posts = driver.find_elements(By.XPATH, '//span[contains(@class, "break-words") or contains(@class, "update-components-text")]')
        print(f"➡️ {len(posts)} posts trouvés pour {keyword}")
